...
void ShowForm()
{
	...
	fprintf(cgiOut, "\">\n");
	fprintf(cgiOut, "<p>\n");
	fprintf(cgiOut, "<h4>Text Field containing Plaintext</h4>\n");
    fprintf(cgiOut, "<tr><td> lastname: <input type=\"text\" name=\"name\" size=1></td></tr><br><td><tr>firstname:<input type=\"text\" name=\"name\"size=1></td></tr>\n");
	fprintf(cgiOut, "<p>\n");
	fprintf(cgiOut, "<h4>Gender:</h4>\n");
	fprintf(cgiOut, "<p>\n");
	fprintf(cgiOut, "<input type=\"radio\" name=\"Gender\"value=\"men\">men\n");
	fprintf(cgiOut, "<input type=\"radio\" name=\"Gender\"value=\"women\">women\n");
	fprintf(cgiOut, "<p>\n");
	fprintf(cgiOut, "<h4>Multiple-Line Text Field</h4>\n");
	fprintf(cgiOut, "<p>\n");
	...
	fprintf(cgiOut, "<p>\n");
	fprintf(cgiOut, "<input type=\"radio\" name=\"hungry\"value=\"Hungry\">Hungry\n");
	fprintf(cgiOut, "<input type=\"radio\" name=\"hungry\"value=\"NoHungry\">NoHungry\n");
	fprintf(cgiOut, "<p>\n");
